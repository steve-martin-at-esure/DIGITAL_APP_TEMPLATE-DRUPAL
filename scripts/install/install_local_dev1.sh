...
npm install 
sudo docker-compose -f docker-compose-local_dev1.yml up -d 
...
echo "The install script (Local-Dev:1) has finsihed. You will need to visit the homepage to initiate the site and then set the Admin password using the 'set_admin_password.sh' script." \
